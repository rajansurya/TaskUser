...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    public interface OnDismissCallback {
         ...
         */
        void onDismiss(ListView listView, int[] reverseSortedPositions, Swipe isRight);
    }
    ...
    public SwipeDismissListViewTouchListener(ListView listView, OnDismissCallback callback) {
        ...
        mAnimationTime = 0;/*listView.getContext().getResources().getInteger(
...
//                    dismiss = true;
                ...
                if (dismiss) 
                {
                    ...
                    Log.e("dismissRight",""+dismissRight);
                    final boolean isRight = dismissRight;
                    mDownView.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    performDismiss(downView, downPosition, isRight);
                                }
                            });
                } else {
                    // cancel
	...
	private void performDismiss(final View dismissView, final int dismissPosition, final boolean isRight) {
        ...
        ValueAnimator animator = ValueAnimator.ofInt(originalHeight, originalHeight).setDuration(mAnimationTime);
        ...
        animator.addListener(new AnimatorListenerAdapter() 
        {
            ...
            public void onAnimationEnd(Animator animation) 
            {
                ...
                if (mDismissAnimationRefCount == 0) 
                {
                    ...
                    mCallback.onDismiss(mListView, dismissPositions, isRight ? Swipe.RIGHT: Swipe.LEFT);
    ...
    public enum Swipe{RIGHT, LEFT, NO}
}
