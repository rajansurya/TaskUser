...
package com.taskmanager.wheel.widget;
...
import com.taskmanager.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		if(viewAdapter instanceof DayArrayAdapter){
			DayArrayAdapter	adapter=(DayArrayAdapter)viewAdapter;
			itemVale=adapter.getItemText(newValue).toString();
		}
