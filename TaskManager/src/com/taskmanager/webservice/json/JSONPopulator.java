...
public class JSONPopulator {
    ...
    public void populateObject(Object object, final Map elements) throws Exception{
     ...
     // iterate over class fields
        for (int i = 0; i < methods.length; ++i) {
            ...
            if (elements.containsKey(name)) {
               ...
               // Method method2 = clazz.getMethod(name, method.getParameterTypes());
    ...
    public Object convert(Class clazz, Type type, Object value, Method method)
        ...
        if (value == null) {
            ...
            throw new Exception("Incompatible types for property " + method.getName());
    }
    ...
    @SuppressWarnings("unchecked")
    private Object convertToArray(Class clazz, Type type, Object value, Method accessor)   throws Exception{
             {
        if (value == null)
            return null;
            ...
            for (int j = 0; j < values.size(); j++) {
                ...
                if (arrayType.equals(Object.class)) {
                    ...
                    throw new Exception("Incompatible types for property " + accessor.getName());
            }
     ...
     */
    @SuppressWarnings("unchecked")
    private Object convertPrimitive(Class clazz, Object value, Method method) throws Exception {
        if (value == null) {
